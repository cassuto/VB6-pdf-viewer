#ifndef UVIEW_FITZ_STORE_H
#define UVIEW_FITZ_STORE_H
...
/*
	...
	uView stores decoded "objects" into a store for potential reuse.
	If the size of the store gets too big, objects stored within it can
	be evicted and freed to recover space. When uView comes to decode
