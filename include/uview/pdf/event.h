#ifndef UVIEW_PDF_EVENT_H
#define UVIEW_PDF_EVENT_H
...
/*
	Document events: the objects via which uView informs the calling app
	of occurrences emanating from the document, possibly from user interaction
	or javascript execution. uView informs the app of document events via a
	callback.
*/
...
/*
	...
	structire are owned by uview and need not be freed by the
	caller.
*/
...
/*
	...
	owned by uview and need not be freed by the caller.
*/
...
/*
	...
	are owned by uview and need not be freed by the caller.
*/
