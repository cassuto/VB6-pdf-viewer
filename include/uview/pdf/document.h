#ifndef UVIEW_PDF_DOCUMENT_H
#define UVIEW_PDF_DOCUMENT_H
...
/*
	...
	uView can locate PDF objects inside the file. Upon an broken
	cross reference table or other parse errors uView will restart
