...
void win_install(void)
{
	...
	OPEN_KEY(software, "Classes", &classes);
	{
		OPEN_KEY(classes, "uView", &uview);
		{
			...
			{
				SET_VALUE(open, "FriendlyAppName", "uView");
		...
		OPEN_KEY(classes, ".epub", &dotepub);
		{
			...
			{
				SET_VALUE(pdf_progids, "uView", "");
				SET_VALUE(xps_progids, "uView", "");
				SET_VALUE(cbz_progids, "uView", "");
				SET_VALUE(epub_progids, "uView", "");
			}
