...
#define uview_icon_bitmap_16_width 16
#define uview_icon_bitmap_16_height 16
static unsigned char uview_icon_bitmap_16_bits[] = {
...
#define uview_icon_bitmap_16_mask_width 16
#define uview_icon_bitmap_16_mask_height 16
static unsigned char uview_icon_bitmap_16_mask_bits[] = {
...
{
	fprintf(stderr, "The uView library supports printing, but this application currently does not\n");
}
...
static void winopen(void)
{
	...
	if (wmhints)
	{
		...
		xicon = XCreateBitmapFromData(xdpy, xwin,
			(char*)uview_icon_bitmap_16_bits,
			uview_icon_bitmap_16_width,
			uview_icon_bitmap_16_height);
		xmask = XCreateBitmapFromData(xdpy, xwin,
			(char*)uview_icon_bitmap_16_mask_bits,
			uview_icon_bitmap_16_mask_width,
			uview_icon_bitmap_16_mask_height);
		if (xicon && xmask)
		{
	...
	if (classhint)
	{
		classhint->res_name = "uview";
		classhint->res_class = "uView";
...
{
	fprintf(stderr, "uview: discarded changes to document\n");
	/* FIXME: temporary dummy implementation */
	return DISCARD;
}
