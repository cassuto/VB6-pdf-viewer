...
FONT_EXPORT int validate(int major, int min)
{
    return !(major == 0 && min == 0);
}

FONT_EXPORT const char *
lookup_base14_font(const char *name, int *size)
{
...
FONT_EXPORT const char *
lookup_builtin_font(const char *name, int is_bold, int is_italic, int *size)
{
...
FONT_EXPORT const char *
lookup_cjk_font(int registry, int serif, int wmode, int *size, int *index)
{
#if 0
#ifndef TOFU_CJK
#ifndef TOFU_CJK_EXT
...
FONT_EXPORT const char *
lookup_noto_font(int script, int serif, int *size)
{
#if 0
    ...
    case UCDN_SCRIPT_HANGUL:
        return lookup_cjk_font(FZ_ADOBE_KOREA_1, serif, 0, size, NULL);
    case UCDN_SCRIPT_HIRAGANA:
    case UCDN_SCRIPT_KATAKANA:
        return lookup_cjk_font(FZ_ADOBE_JAPAN_1, serif, 0, size, NULL);
    case UCDN_SCRIPT_BOPOMOFO:
        return lookup_cjk_font(FZ_ADOBE_GB_1, serif, 0, size, NULL);
...
FONT_EXPORT const char *
lookup_noto_symbol_font(int *size)
{
#if 0
#ifndef TOFU_SYMBOL
...
FONT_EXPORT const char *
lookup_noto_emoji_font(int *size)
{
#if 0
#ifndef TOFU_EMOJI
